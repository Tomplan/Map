import{j as e,r as k,R as X}from"./vendor-react-868f88e1.js";import{ax as ze,ag as ee,ac as S,af as Te,ad as O,ay as Be,az as Re,aA as se,au as pe,aB as ve,aC as we,aD as Me,ae as Ne,aE as Ve,ap as Ie,aF as De,aG as je,aH as Pe,aI as Ue,aJ as xe,aK as Se,ak as Ce,aL as Oe,aM as Fe,ai as he,aN as be,aO as fe,aP as Ge,aQ as Le,aR as Ke}from"./vendor-eeb19b8c.js";import{u as le}from"./useUserRole-2beb3960.js";import{M as qe,e as ae,f as We,h as He,i as Ze,s as _e}from"./index-f332ba2f.js";import{u as _,T as Je}from"./vendor-i18n-7a95c078.js";import{M as Ye}from"./vendor-markdown-9622a2d0.js";import{u as $e,a as Qe}from"./useCountViews-2dca8c4e.js";import"./vendor-supabase-9b9847fe.js";import"./vendor-map-41af7335.js";function Xe({isOpen:t,onClose:a,newYear:r,onConfirm:m}){const{t:c}=_();return e.jsx(qe,{isOpen:t,onClose:a,title:c("admin.yearSwitcher.modalTitle",{year:r}),size:"md",children:e.jsxs("div",{className:"px-6 py-4 space-y-4 text-sm text-gray-700",children:[e.jsx("p",{children:e.jsx(Je,{i18nKey:"admin.yearSwitcher.modalIntro",values:{year:r},components:{strong:e.jsx("strong",{})}})}),e.jsxs("ul",{className:"list-disc list-inside text-sm",children:[e.jsxs("li",{children:[e.jsx("strong",{children:c("admin.yearSwitcher.willChange.subscriptions")})," —"," ",c("admin.yearSwitcher.willChange.subscriptionsDesc")]}),e.jsxs("li",{children:[e.jsx("strong",{children:c("admin.yearSwitcher.willChange.assignments")})," —"," ",c("admin.yearSwitcher.willChange.assignmentsDesc")]}),e.jsxs("li",{children:[e.jsx("strong",{children:c("admin.yearSwitcher.willChange.program")})," —"," ",c("admin.yearSwitcher.willChange.programDesc")]})]}),e.jsx("p",{className:"text-gray-500",children:c("admin.yearSwitcher.wontChangeIntro")}),e.jsx("ul",{className:"list-disc list-inside text-sm text-gray-500",children:e.jsxs("li",{children:[e.jsx("strong",{children:c("admin.yearSwitcher.wontChange.companies")})," —"," ",c("admin.yearSwitcher.wontChange.companiesDesc")]})}),e.jsxs("div",{className:"flex justify-end gap-3 mt-3",children:[e.jsx("button",{onClick:a,className:"px-3 py-2 bg-white border rounded",children:c("common.cancel")}),e.jsx("button",{onClick:m,className:"px-3 py-2 bg-blue-600 text-white rounded",children:c("admin.yearSwitcher.switchButton",{year:r})})]})]})})}const ke={dashboard:{title:{en:"Dashboard Overview",nl:"Dashboard Overzicht"},content:{en:`
