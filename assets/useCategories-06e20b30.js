import{r as l,s as n,aZ as m,a_ as A,a$ as q,b0 as O,b1 as S,b2 as k,b3 as H,Q as N,b4 as x,b5 as P}from"./index-260573d4.js";const d={mdiCarOutline:A,mdiTent:q,mdiTrailer:O,mdiCarCog:S,mdiAirplane:k,mdiHomeCity:H,mdiAccountGroup:N,mdiTerrainIcon:x,mdiCellphone:P,mdiDotsHorizontal:m};function L(g="nl"){const[_,u]=l.useState([]),[p,y]=l.useState(!0),[h,f]=l.useState(null),i=l.useCallback(async()=>{var t;try{y(!0),f(null);const{data:r,error:o}=await n.from("categories").select(`
          id,
          slug,
          icon,
          color,
