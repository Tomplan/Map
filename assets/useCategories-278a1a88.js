import{r as l,s as n,aH as m,aI as A,aJ as O,aK as q,aL as H,aM as N,aN as S,aO as k,aP as P,aQ as x}from"./index-8fb29835.js";const d={mdiCarOutline:A,mdiTent:O,mdiTrailer:q,mdiCarCog:H,mdiAirplane:N,mdiHomeCity:S,mdiAccountGroup:k,mdiTerrainIcon:P,mdiCellphone:x,mdiDotsHorizontal:m};function L(g="nl"){const[_,u]=l.useState([]),[p,y]=l.useState(!0),[h,f]=l.useState(null),i=l.useCallback(async()=>{var t;try{y(!0),f(null);const{data:r,error:o}=await n.from("categories").select(`
          id,
          slug,
          icon,
          color,
