import{r as l}from"./vendor-react-868f88e1.js";import{s as n}from"./index-f332ba2f.js";import{bs as m,bt as A,bu as q,bv as O,bw as S,bx as k,by as x,aB as H,bz as N,bA as z}from"./vendor-eeb19b8c.js";const d={mdiCarOutline:A,mdiTent:q,mdiTrailer:O,mdiCarCog:S,mdiAirplane:k,mdiHomeCity:x,mdiAccountGroup:H,mdiTerrainIcon:N,mdiCellphone:z,mdiDotsHorizontal:m};function M(g="nl"){const[_,u]=l.useState([]),[p,y]=l.useState(!0),[h,f]=l.useState(null),i=l.useCallback(async()=>{var t;try{y(!0),f(null);const{data:r,error:o}=await n.from("categories").select(`
          id,
          slug,
          icon,
          color,
        ...
        `).in("company_id",t);if(o)throw o;const s={};return r.forEach(e=>{s[e.company_id]||(s[e.company_id]=[]);const a=e.categories,c=a.category_translations.find(T=>T.language===g)||a.category_translations[0];s[e.company_id].push({id:a.id,slug:a.slug,icon:d[a.icon]||m,iconName:a.icon,color:a.color,name:(c==null?void 0:c.name)||a.slug})}),s}catch(r){return console.error("Error fetching all company categories:",r),{}}},[g]);return{categories:_,loading:p,error:h,createCategory:C,updateCategory:w,deleteCategory:b,getCompanyCategories:E,getAllCompanyCategories:v,assignCategoriesToCompany:async(t,r)=>{try{if(await n.from("company_categories").delete().eq("company_id",t),r.length>0){const o=r.map(e=>({company_id:t,category_id:e})),{error:s}=await n.from("company_categories").insert(o);if(s)throw s}return{success:!0}}catch(o){return console.error("Error assigning categories:",o),{success:!1,error:o.message}}},getCategoryStats:async()=>{try{const{data:t,error:r}=await n.from("company_categories").select("category_id");if(r)throw r;const o={};return t.forEach(s=>{o[s.category_id]||(o[s.category_id]=0),o[s.category_id]++}),o}catch(t){return console.error("Error fetching category stats:",t),{}}},refetch:i}}export{M as u};
