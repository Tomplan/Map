import{r as l}from"./vendor-react-3437b308.js";import{s as n}from"./index-7a334b3d.js";import{bk as m,bl as q,bm as A,bn as k,bo as O,bp as S,bq as H,aw as N,br as x,bs as P}from"./vendor-3047817a.js";const d={mdiCarOutline:q,mdiTent:A,mdiTrailer:k,mdiCarCog:O,mdiAirplane:S,mdiHomeCity:H,mdiAccountGroup:N,mdiTerrainIcon:x,mdiCellphone:P,mdiDotsHorizontal:m};function B(g="nl"){const[_,u]=l.useState([]),[p,y]=l.useState(!0),[h,f]=l.useState(null),i=l.useCallback(async()=>{var t;try{y(!0),f(null);const{data:r,error:o}=await n.from("categories").select(`
          id,
          slug,
          icon,
          color,
