import{r as i,s as n,aZ as d,a_ as q,a$ as x,b0 as H,b1 as J,b2 as P,b3 as j,Q as z,b4 as G,b5 as L}from"./index-4ec74ce4.js";const y={mdiCarOutline:q,mdiTent:x,mdiTrailer:H,mdiCarCog:J,mdiAirplane:P,mdiHomeCity:j,mdiAccountGroup:z,mdiTerrainIcon:G,mdiCellphone:L,mdiDotsHorizontal:d};function Q(l="nl"){const[h,f]=i.useState([]),[C,_]=i.useState(!0),[w,p]=i.useState(null),[b,m]=i.useState({}),g=i.useCallback(async()=>{var t;try{_(!0),p(null);const{data:r,error:o}=await n.from("categories").select(`
          id,
          slug,
          icon,
          color,
