import{r as l}from"./vendor-react-600751b5.js";import{s as n}from"./index-c9551a19.js";import{bi as m,bj as q,bk as A,bl as k,bm as O,bn as S,bo as H,aw as N,bp as j,bq as x}from"./vendor-57b332a3.js";const d={mdiCarOutline:q,mdiTent:A,mdiTrailer:k,mdiCarCog:O,mdiAirplane:S,mdiHomeCity:H,mdiAccountGroup:N,mdiTerrainIcon:j,mdiCellphone:x,mdiDotsHorizontal:m};function B(g="nl"){const[_,u]=l.useState([]),[p,y]=l.useState(!0),[h,f]=l.useState(null),i=l.useCallback(async()=>{var t;try{y(!0),f(null);const{data:r,error:o}=await n.from("categories").select(`
          id,
          slug,
          icon,
          color,
