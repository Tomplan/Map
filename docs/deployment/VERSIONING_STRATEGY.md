...
export const whatsNew = [
  {
    date: '2025-11-21',
    changes: ['Added in-app help system', 'Improved marker tooltips', 'Enhanced logo uploader'],
  },
  {
    date: '2025-11-15',
    changes: ['Added event subscriptions tab', 'Fixed import validation'],
  },
...
export function getHelpContent(page) {
  ...
  return helpContentByVersion[currentVersion]?.[page] || helpContentByVersion['1.0.0'][page]; // Fallback
}
```
