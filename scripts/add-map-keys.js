...
const newNlKeys = {
  ...
  defaultAppearanceAssigned:
    'Dit definieert de standaardweergave voor kraam markers (ID < 1000) waaraan een bedrijf is toegewezen.',
  defaultAppearanceUnassigned:
    'Dit definieert de standaardweergave voor kraam markers (ID < 1000) waaraan geen bedrijf is toegewezen.',
  overrideDefaultsNote:
    'Individuele kraam markers kunnen deze standaarden overschrijven door hun eigen waarden in de Weergave-tabel in te vullen.',
