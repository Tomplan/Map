...
jest.mock('react-i18next', () => ({
  useTranslation: () => ({
    t: (k, opts) => {
      ...
      if (k === 'admin.yearSwitcher.modalIntro')
        return `Are you sure you want to switch to ${opts.year}?`;
      if (k.startsWith('admin.yearSwitcher.willChange'))
        return (
          {
      ...
      if (k.startsWith('admin.yearSwitcher.wontChange'))
        return (
          {
  ...
  Trans: ({ i18nKey, values }) => {
    ...
    if (i18nKey === 'admin.yearSwitcher.modalIntro')
      return `Are you sure you want to switch to ${values?.year || ''}?`;
    return i18nKey;
  },
}));
