            ...
            <div className="space-y-3">
              ...
              <div>
                <label className="block text-sm font-medium mb-1 text-gray-900">
                  {t('helpPanel.companies.companyLogo')}
                </label>
                <LogoUploader
                    ...
                    <>
                      ...
                      <td className={`py-2 px-3 border-b text-left ${!isOrg ? 'bg-green-50' : ''}`}>
                        <span className="text-xs">
                          {item.contact || <span className="text-gray-400 italic">Not set</span>}
                        </span>
                      </td>
                      ...
                      <td className={`py-2 px-3 border-b text-left ${!isOrg ? 'bg-green-50' : ''}`}>
                        <span className="text-xs">
                          {item.email || <span className="text-gray-400 italic">Not set</span>}
                        </span>
                      </td>
                    </>
                  )}
