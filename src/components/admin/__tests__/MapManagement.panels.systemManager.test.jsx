...
jest.doMock('../../../hooks/useUserRole', () => () => ({
  role: 'system_manager', loading: false, userInfo: {},
...
describe('MapManagement panels for system_manager', () => {
  it('shows left marker list and right details for editable user', () => {
    render(<MapManagementReloaded markersState={[{ id: 7, lat: 52.1, lng: 4.3 }]} setMarkersState={jest.fn()} updateMarker={jest.fn()} selectedYear={2025} archiveMarkers={jest.fn()} copyMarkers={jest.fn()} />);
