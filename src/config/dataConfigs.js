...
export const dataConfigs = {
  ...
  unsubscribed_companies: {
    ...
    transformExport: async (...args) => dataConfigs.companies.transformExport(...args),
    labels: {
      singular: 'Unsubscribed Company',
      plural: 'Unsubscribed Companies',
      exportButton: 'Export Unsubscribed Companies',
      importButton: 'Import Unsubscribed Companies',
      modalTitle: 'Import Unsubscribed Companies',
      exportFilename: 'unsubscribed-companies-export',
    },
  },
  ...
  subscribed_companies: {
    ...
    transformExport: async (...args) => dataConfigs.companies.transformExport(...args),
    labels: {
      singular: 'Subscribed Company',
      plural: 'Subscribed Companies',
      exportButton: 'Export Subscribed Companies',
      importButton: 'Import Subscribed Companies',
      modalTitle: 'Import Subscribed Companies',
      exportFilename: 'subscribed-companies-export',
    },
  },
