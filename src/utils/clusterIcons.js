...
export function iconCreateFunction(cluster) {
  ...
  <img src='${import.meta.env.BASE_URL}assets/logos/4x4Vakantiebeurs.png' alt='logo' style='width:40px;height:40px;object-fit:contain;display:block;margin:auto;position:relative;left:1px;top:10px;' />
      </div>`,
    glyphColor: 'white',
    glyphSize: '40px',
