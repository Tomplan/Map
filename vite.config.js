      ...
      output: {
        manualChunks(id) {
          ...
          if (id.includes('node_modules')) {
            ...
            // map related libs
            if (id.includes('leaflet') || id.includes('react-leaflet') || id.includes('@mapbox') || id.includes('proj4')) return 'vendor-map'

            // UI / animation / icons
            if (id.includes('framer-motion') || id.includes('material-icons') || id.includes('react-icons')) return 'vendor-ui'
            ...
            if (id.includes('react-icons') || id.includes('material-icons') || id.includes('country-flag-icons')) return 'vendor-icons'
